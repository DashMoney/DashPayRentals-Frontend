...
class SelectedRentalPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      LoadingRental: true,
        ...
        <div className="bodytext">
          ...
          {this.props.isLoginComplete ? (
              ...
              <div className="d-grid gap-2">
                ...
                maxDays ? (
                  <Button
                    ...
                    variant="primary"
                    onClick={() =>
                      this.props.handleMakeRequestModal(
                        this.state.arrivalMs,
                        this.state.departureMs
                      )
                    }
                  >
                    <b>Request Reservation</b>
                  </Button>
                ) : (
            ...
            <>
              ...
              >
                <b> *Sign in to reserve you spot!*</b>{" "}
              </p>
            </>
          )}
...
export default SelectedRentalPage;
