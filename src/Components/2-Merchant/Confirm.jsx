...
class Confirm extends React.Component {
  ...
  render() {
    ...
    //   blockRequest = this.props.Rentals.find((rental) => {
    ...
    let isBlockConfirm = this.props.confirm.$ownerId === rental.$ownerId; //&& this.props.confirm.reqId === rental.;

    //let request = undefined;

    let request = this.props.RentalRequests.find((request) => {
      return request.$id === this.props.confirm.reqId;
    });
    ...
    return (
      <>
        ...
        {this.props.DisplayRequests === "Blocked Off" && isBlockConfirm ? (
          <>
        ...
        {this.props.DisplayRequests === "Confirmed" && !isBlockConfirm ? (
          <>
            <Card
              id="card"
